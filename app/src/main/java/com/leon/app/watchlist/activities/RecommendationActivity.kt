...
class RecommendationActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private fun setupDrawer() {
        drawerToggle = BlurActionBarDrawerToggle(this@RecommendationActivity, drawerLayoutgesamt,
                R.string.auf,
                R.string.zu)
